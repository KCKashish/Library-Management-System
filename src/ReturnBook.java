...
public class ReturnBook extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {   SimpleDateFormat format = new SimpleDateFormat("dd-MM-yyyy");
            ...
            if(rs.next())
            {
                ...
                Date issueDate = format.parse(issueDateStr);
                System.out.println("Issue Date: " + issueDate);
                System.out.println("Current Date: " + date);
                long diffInMillies = Math.abs(date.getTime() - issueDate.getTime()); // Corrected calculation
                long diff = diffInMillies / (24 * 60 * 60 * 1000); // Convert milliseconds to days

                if (diff > 14) {
                    double fine = (diff-14) * 5; // Calculate fine (5 Rs per day)
                    JOptionPane.showMessageDialog(this, "You have overdue days: " + (diff-14) + " and fine is: Rs " + fine);
                }
    ...
    public void connect()
    {
        ...
        {  
            ...
            "jdbc:mysql://localhost:3306/ooad","root","hamsini123");   
