...
public class IssuedBooks extends javax.swing.JFrame {
    ...
    private void c1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_c1ActionPerformed
        ...
        {
            c2.removeAllItems();
            c2.addItem("Select Class");c2.addItem("CSE");c2.addItem("BIOTECHNOLOGY");c2.addItem("COMMERCE");
        }
        if(c1.getSelectedItem()=="Arts")
        {
            c2.removeAllItems();
            c2.addItem("Select Class");c2.addItem("LITERATURE");c2.addItem("PHILOSOPHY");c2.addItem("HISTORY");
        }
        if(c1.getSelectedItem()=="Commerce")
        {
            c2.removeAllItems();
            c2.addItem("Select Class");c2.addItem("ACCOUNTING");c2.addItem("FINANCE");c2.addItem("BUISNESS");
        }
    ...
    public void connect()
    {
        ...
        {  
            ...
            "jdbc:mysql://localhost:3306/mydb","root","ajja7777");  
