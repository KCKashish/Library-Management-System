...
public class AddNewBook extends javax.swing.JFrame {
    ...
    private void c3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_c3ActionPerformed
        ...
        {
            c4.removeAllItems();
            c4.addItem("Select Class");c4.addItem("CSE");c4.addItem("BITOECHNOLOGY");c4.addItem("ECE");
        }
        if(c3.getSelectedItem()=="Arts")
        {
            c4.removeAllItems();
            c4.addItem("Select Class");c4.addItem("LITERATURE");c4.addItem("PHILOSOPHY");c4.addItem("HISTORY");
        }
        if(c3.getSelectedItem()=="Commerce")
        {
            c4.removeAllItems();
            c4.addItem("Select Class");c4.addItem("ACCOUNTING");c4.addItem("FINANCE");c4.addItem("BUISNESS");
        }
    ...
    public void connect()
    {
        ...
        {  
            ...
            "jdbc:mysql://localhost:3306/ooad","root","kashish"); 
